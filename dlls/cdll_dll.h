...
enum WeaponId
{
	...
	WEAPON_FIFTYCAL,
	WEAPON_MP5,
	WEAPON_SUIT = 31 //TODO: Make this obsolete!
};
...
#define DMG_GIB_CORPSE (DMG_CRUSH | DMG_FALL | DMG_BLAST | DMG_SONIC | DMG_CLUB) //| DMG_HEAVYSHOT) // Kamel: Was gonna make this last one bullet, but gibs... until I realised I could just OR it in
