...
void HUD_InitClientWeapons()
{
	...
	HUD_PrepEntity(&g_FiftyCal, &player);
...
void HUD_WeaponsPostThink(local_state_s* from, local_state_s* to, usercmd_t* cmd, double time, unsigned int random_seed)
{
	...
	player.ammo_50cal = (int)from->client.vuser1[0];
	player.ammo_9mm = (int)from->client.vuser1[1];
	...
	//HL Weapons
	to->client.vuser1[0] = player.ammo_50cal;
	to->client.vuser1[1] = player.ammo_9mm;
